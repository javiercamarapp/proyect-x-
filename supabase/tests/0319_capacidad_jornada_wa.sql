...
begin
  ...
  insert into public.viaje(id, tenant_id, operador_id, aceptado_en)
  ...
  foreach n in array array[0, 1, 399, 400, 401, 1520] loop
    ...
    select count(*), coalesce(bool_or(r.hay_mas), false), array_agg(r.claim_token)
      ...
      from public.reclamar_jornadas_por_derivar(
        '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 400,
        'borde-' || n, 180
      ) r;
...
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 1, 'muerto', 30
);

do $$
declare n integer;
begin
  select count(*) into n from public.reclamar_jornadas_por_derivar(
    '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 1, 'prematuro', 30
  );
...
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 1, 'recuperador', 30
);
...
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 400, 'worker-a', 180
);
create temporary table audit_worker_b as
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 400, 'worker-b', 180
);
...
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 400, 'worker-c', 180
);
create temporary table audit_worker_d as
select * from public.reclamar_jornadas_por_derivar(
  '2026-09-02 06:00:00+00', '2026-09-03 05:59:59+00', 400, 'worker-d', 180
);
